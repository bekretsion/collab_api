...
[![Build Status](https://github.com/ueberdosis/collab-api/workflows/build/badge.svg)](https://github.com/ueberdosis/collab-api/actions)
...
## Documentation
The full documentation is a available on [collab-api.dev/introduction](https://tiptap.dev/docs/collab-api/introduction).

## Cloud Hosting

You want to use Collab API, but don't want to care about hosting? Check our [Cloud Offering: Tiptap Collab](https://tiptap.dev/collab)


## Feedback
Send all your questions, feedback and bug reports to [humans@tiptap.dev](mailto:humans@tiptap.dev) or [create an issue](https://github.com/ueberdosis/collab-api/issues/new/choose) here.
...
Using Collab API in production? Invest in the future of Collab API and [become a sponsor!](https://github.com/sponsors/ueberdosis)
