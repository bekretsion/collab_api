# @collab-api/extension-s3
[![Version](https://img.shields.io/npm/v/@collab-api/extension-s3.svg?label=version)](https://www.npmjs.com/package/@collab-api/extension-s3)
[![Downloads](https://img.shields.io/npm/dm/@collab-api/extension-s3.svg)](https://npmcharts.com/compare/tiptap?minimal=true)
[![License](https://img.shields.io/npm/l/@collab-api/extension-s3.svg)](https://www.npmjs.com/package/@collab-api/extension-s3)
[![Sponsor](https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub)](https://github.com/sponsors/ueberdosis)

A S3-compatible persistence driver for [Collab API](https://github.com/ueberdosis/collab-api). Stores Y.js documents in Amazon S3 or S3-compatible storage (MinIO, DigitalOcean Spaces, Cloudflare R2, Backblaze B2, etc.).

## Installation

```bash
npm install @collab-api/extension-s3
```
...
- **prefix**: Key prefix for documents (default: 'collab-api-documents/')
...
You can also use the S3 extension with the Collab API CLI:

```bash
# Basic usage
collab-api --s3 --s3-bucket my-documents

# MinIO setup (forcePathStyle automatically enabled)
collab-api --s3 --s3-bucket collab-api-documents --s3-endpoint http://localhost:9000
```
...
[📚 S3 Extension Documentation](https://tiptap.dev/docs/collab-api/server/extensions/s3)
