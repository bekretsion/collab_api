...
export interface Configuration {
	...
	identifier: string;
	/**
	 * Namespace for Redis keys, if none is provided 'collab-api' is used
	 */
	prefix: string;
	/**
...
export class Redis implements Extension {
	...
	/**
	 * Handle awareness update messages received directly by this CollabApi instance.
	 */
	async onAwarenessUpdate({
		...
		// Do not publish if there is no connection: it fixes this issue: "https://github.com/ueberdosis/collab-api/issues/1027"
	...
	/**
	 * if the ydoc changed, we'll need to inform other CollabApi servers about it.
	 */
